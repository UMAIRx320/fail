...
def back():
	login()
def coli():
	print(f'{U}_________________________________{P}')
#------------------[KONTOL]-----------------#
def banner():
	print(f'''\t{asu}
___________                                       
\__    ___/___________ ___  __ ___________  ______
  |    |  \_  __ \__  \\  \/ // __ \_  __ \/  ___/
  |    |   |  | \// __ \\   /\  ___/|  | \/\___ \ 
  |____|   |__|  (____  /\_/  \___  >__|  /____  >
                      \/          \/           \/
                      
{m}•{k}•{h}•{sir} Jaringan disarankan Axis Telekom {x}{m}•{k}•{h}•{x}''')
#--------------------[ MASUK ]--------------#
def login():
	try:
...
def menu(my_name,my_id):
	...
	print(f'└─ Github   : https://github.com/Traversxd')
	nazri_ganteng('=' * 40)
...
def passwrd():
	global prog,des
	print('')
	cetak(nel(f'{P}Results {H}OK{P} Otomatis tersave di folder [{U}{okc}{P}]')) 
	cetak(nel(f'{P}Results {K}CP{P} Otomatis tersave di folder [{M}{cpc}{P}]')) 
#	coli()
